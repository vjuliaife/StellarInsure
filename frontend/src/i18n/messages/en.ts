const en = {
  ...
  createPolicy: {
    ...
    receipt: {
      ...
      nextStepsItem1: 'Track settlement and status updates from transaction history.',
      nextStepsItem2: 'Share this receipt with operations or compliance stakeholders.',
      nextStepsItem3: 'Create another policy for a separate trigger condition.',
      share: 'Share Receipt',
